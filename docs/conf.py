...
version = tecscipyModbusTCP.__version__

# The full version, including alpha/beta/rc tags.
release = tecscipyModbusTCP.__version__
...
man_pages = [(master_doc, "pymodbustcp", "pyModbusTCP Documentation", [author], 1)]
